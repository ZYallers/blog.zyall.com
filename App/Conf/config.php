...
return  array(
    ...
    'COOKIE_PREFIX'         => 'BLOG_ZYALL_COM_COOKIE_',      // Cookie前缀 避免冲突

    /* 默认设定 */
    'DEFAULT_M_LAYER'       =>  'Service', // 默认的模型层名称
    ...
    'DEFAULT_THEME'         => 'Pintuer',  // 默认模板主题名称
    // 可以通过在URL地址中传入t参数来切换如http://localhost/theme/?t=think，如果切换到一个不存在的模板主题，就会使用默认主题。
    ...
    'DEFAULT_FILTER'        => '', // 默认参数过滤方法，默认是htmlspecialchars 用于 $this->_get('变量名');$this->_post('变量名')...
    ...
    'SESSION_PREFIX'        => 'BLOG_ZYALL_COM_SESSION_', // session 前缀
    ...
    'URL_ROUTE_RULES'       => array( //定义路由规则
        '/^b(\d+)$/'        => 'index.php/Blog/view?id=:1',
        '/^c(\d+)$/'            => 'index.php/Index/index?cid=:1',
        'admin'             => 'index.php/User/login',
     ),
