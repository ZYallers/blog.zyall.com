...
( function( $ ) {
    ...
    $.fn.highlightSyntax = function( options ) {
                ...
                "code": [
                    {
                        ...
                        class: 'const',
                        pattern: "(?:(var|new|function|private|if|else|for|in|public|protected|return|foreach|each)\\s)"
                    }, {
                        class: 'operator',
                        pattern: "((?:[\\+\\-\\=\\!\\|\\:\\[\\]\\(\\)\\{\\}\\>\\<\\->\\$]|&amp;|&lt;|&gt;){1,}|(?:[^\\*\\/]\\/(?!\\/|\\*)))"
                    }, {
        ...
        return this.each( function() {
            ...
            _codeDefinitionTitle = _codeDefinitionTitle.replace( /lang-|prettyprint/g, "" );
            ...
            getDefinitions( _codeDefinitionTitle, _settings ).done( function( _definitions ) {
                ...
                for ( var k in _definitions ) {
                    _computedRegExString += _definitions[k].pattern + "|";
                }
